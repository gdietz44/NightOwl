...
- (HorizontalPickerViewStyle)pickerViewStyleForCollectionViewLayout:(AKCollectionViewLayout *)layout;
@end
...
@interface HorizontalPickerViewDelegateIntercepter : NSObject <UICollectionViewDelegate>
@property (nonatomic, weak) HorizontalPickerView *pickerView;
@property (nonatomic, weak) id <UIScrollViewDelegate> delegate;
@end

@interface HorizontalPickerView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, assign) NSUInteger selectedItem;
@property (nonatomic, strong) HorizontalPickerViewDelegateIntercepter *intercepter;
...
- (void)initialize
{
    ...
    self.pickerViewStyle = self.pickerViewStyle ?: HorizontalPickerViewStyle3D;
    ...
    self.intercepter = [HorizontalPickerViewDelegateIntercepter new];
...
@implementation HorizontalPickerViewDelegateIntercepter
