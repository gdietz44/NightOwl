...
- (void)addPlaceholderLabel {
    ...
    self.placeholderLabel.textColor = [UIColor colorWithRed:216.0/255.0 green:216.0/255.0 blue:216.0/255.0 alpha:1.0];
    self.placeholderLabel.font = [UIFont fontWithName:@"HelveticaNeue-Italic" size:12.0];
